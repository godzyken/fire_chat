...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) =>
      widget.channel != null ? buildStreamChannel : buildStreamChat;
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child: ProfileHeaderWidget(
                    name: widget.channel.extraData['name'],
                  ),
                ),
                Expanded(
                  flex: 5,
                  child: Container(
                    ...
                    child: MessagesWidget(
                        idUser: '${widget?.members?.iterator?.current?.uid}'),
                  ),
                ),
                Expanded(
                    flex: 1,
          ...
          body: SafeArea(
            child: Column(
              children: <Widget>[
                Expanded(
                  flex: 1,
                  child: ProfileHeaderWidget(name: '${widget?.userModel?.name}'),
                ),
                Expanded(
                  flex: 4,
                  child: Container(

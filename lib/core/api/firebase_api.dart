...
class FirebaseApi {
  ...
  static Future uploadMessage(UserModel userModel, String message) async {
    final refMessages = FirebaseFirestore.instance
        .collection('chats/${userModel?.uid}/messages');
  ...
  static Stream<List<MessageModel>> getMessages(String idUser) =>
      FirebaseFirestore.instance
          .collection('chats/$idUser/messages')
          .orderBy(MessageModelField.createdAt, descending: true)
          .snapshots()
          .transform(Utils.transformer(MessageModel.fromJson));

  static Stream<List<MessageModel>> getMessage() => FirebaseFirestore.instance
      .collection('messages')
      .orderBy(MessageModelField.createdAt, descending: true)
      .snapshots()
      .transform(Utils.transformer(MessageModel.fromJson));
  ...
  static Future uploadChannels(String idUser, String channel) async {
    ...
    final MessageModel message = Get.find();
  ...
  static Future<String> uploadImage(String path, File file) async {
    final ref = FirebaseFirestore.instance.collection('users/$file/photoUrl');
  ...
  static Future<bool> login() async {
    ...
    final userCredential = await AuthController.to.firebaseUser.value
